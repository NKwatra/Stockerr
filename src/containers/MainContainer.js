...
class MainContainer extends React.Component {
    ...
    render() {
        ...
        return (<div className="row mt-5 pt-5">
            ...
            <Arrow arrowClasses={`${rightArrow}`} leftActive={this.props.leftActive} activateLeft={this.props.toggleLeftArrow}
                deactivateRight={this.props.toggleRightArrow} index={this.props.index}
                updateIndex={this.props./>
        </div>)
        }
